...
.EXAMPLE
   ...
   .\CleanUpOSDisk.ps1 -ComputerName localhost
.EXAMPLE
   To run script to clean the local computers OSDrive and also clean folders C:\Temp and C:\Tools
   .\CleanUpOSDisk.ps1 -ComputerName localhost -Folder "C:\Temp,C:\Tools"
#>
