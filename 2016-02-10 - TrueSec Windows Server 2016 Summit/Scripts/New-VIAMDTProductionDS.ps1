...
New-Item -Path "DS002:\Operating Systems" -enable "True" -Name "Windows Server 2016" -Comments "" -ItemType "folder"
New-Item -Path "DS002:\Task Sequences" -enable "True" -Name "Windows Server 2016" -Comments "" -ItemType "folder"
...
New-Item -Path "DS002:\Out-Of-Box Drivers" -enable "True" -Name "Windows Server 2016" -Comments "" -ItemType "folder"
