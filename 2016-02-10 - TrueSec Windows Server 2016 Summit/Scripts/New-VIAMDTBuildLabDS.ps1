...
New-Item -Path "DS001:\Operating Systems" -enable "True" -Name "Windows Server 2016" -Comments "" -ItemType "folder"
New-Item -Path "DS001:\Task Sequences" -enable "True" -Name "Reference Task Sequences" -Comments "" -ItemType "folder"
New-Item -Path "DS001:\Packages" -enable "True" -Name "Windows Server 2016" -Comments "" -ItemType "folder"

# Create MDT Selection Profiles
New-Item -path "DS001:\Selection Profiles" -enable "True" -Name "Windows Server 2016 Packages" -Comments "" -Definition "<SelectionProfile><Include path=`"Packages\Windows Server 2016`" /></SelectionProfile>" -ReadOnly "False"
